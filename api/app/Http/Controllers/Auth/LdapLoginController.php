...
final class LdapLoginController extends Controller
{
    public function __construct(
        private readonly IdpProviderService $providers,
        private readonly LdapAuthenticatorContract $authenticator
    ) {}
    ...
    public function login(LdapLoginRequest $request): JsonResponse
    {
        ...
        /** @var array{provider:string,username:string,password:string} $input */
