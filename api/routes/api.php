...
use App\Http\Controllers\Auth\SamlAssertionConsumerController;
use App\Http\Controllers\Auth\SamlRedirectController;
...
Route::get('/auth/saml/redirect', [SamlRedirectController::class, 'redirect']);
Route::post('/auth/saml/acs', [SamlAssertionConsumerController::class, 'consume']);
