...
- [ ] Ensure queue infrastructure sized (worker pools, retry policies, dead-letter strategy).
...
- [ ] Implement queue jobs and event dispatchers per connector type.
- [ ] Create encrypted configuration storage + CRUD UI/API for connector secrets.
