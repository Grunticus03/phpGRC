...
function DateRangePicker({ start, end, onChange, onComplete, onClear }: DateRangePickerProps): JSX.Element {
    ...
    <div className="border rounded p-3 d-inline-block">
      ...
      <div className="d-flex flex-column gap-2">
        <div className="small text-muted">
          {pendingStart ? pendingStart : "Start not selected"}
          {pendingEnd ? ` → ${pendingEnd}` : pendingStart ? " → ?" : ""}
        </div>
        <button
          type="button"
